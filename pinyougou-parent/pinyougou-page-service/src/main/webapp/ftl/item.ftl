...
<body ng-app="pinyougou" ng-controller="itemController" ng-init="init()" num=1;loadSku()">
	<!--页面顶部开始-->
					...
					<div class="summary">
						...
						<div class="summary-wrap">
							...
							<div class="fl fix-width">
								...
								<em class="t-gray">${goods.caption}</em>
							</div>
						</div>
					</div>
					<div class="support">
						...
						<div id="specification" class="summary-wrap clearfix">
						   <#list specificationList as item>
							<dl>
								...
								<a ng-click="selectSpecificationItems('${item.attributeName}','${value}')" href="javascript:;" class="{{isSelected('${item.attributeName}','${value}')?'selected':''}} ">${value}<span title="点击取消选择">&nbsp;</span></a>
									</#list>
</dd>
							</dl>
						   </#list>
