...
app.controller('typeTemplateController', function($scope, $controller,
		typeTemplateService, brandService, specificationService) {// 由于需要在type_template页面使用Select2,所以将brandService,specificationService服务引入到typeTemplateController
	...
	$scope.initialize = function() {//由于只能用一次ng-init,所以将以上两个方法封装到里面集中初始化
		$scope.findBrandList();
